...
type NotificationsClientProps = {
  ...
  initialDebugInfo: DebugEnvelope["debug"] | null;
};
...
export default function NotificationsClient({
  ...
  const initialItems = useMemo(
    () => normalizeNotifications(unwrapDebugPayload(initialPayload)),
    [initialPayload],
  );
  ...
  useEffect(() => {
    ...
    if (currentUserId && currentUserId === initializedUserRef.current) {
      return;
    }
